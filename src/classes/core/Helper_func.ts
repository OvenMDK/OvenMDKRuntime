...
export function registerServerItem(
  ...
  const $$itemGetAttributes = ModAPI.reflect.getClassById(
    "net.minecraft.item.Item"
  ).methods.getItemAttributeModifiers.method;
  ...
  if (ModAPI.is_1_12) {
    var $$ResultEnum =
      ModAPI.reflect.getClassByName("EnumActionResult").staticVariables;
    var $$ActionResult =
      ModAPI.reflect.getClassByName("ActionResult").constructors[0];
    nmi_OvenItem.prototype.$onItemRightClick = function (
      $$world,
      $$player,
      $handEnum,
  ...
  if (ModAPI.is_1_12) {
    var $$ResultEnum =
      ModAPI.reflect.getClassByName("EnumActionResult").staticVariables;
    nmi_OvenItem.prototype.$onItemUse = function (
      $$itemstack,
      $$player,
      $$world,
      $$blockpos
  ...
  nmi_OvenItem.prototype.$onUpdate = function (
    $$itemstack,
    $$world,
    $$player,
    $$hotbar_slot,
  ...
  nmi_OvenItem.prototype.$onItemUseFinish = function (
    $$itemstack,
    $$world,
    $$player
  ) {
  ...
  nmi_OvenItem.prototype.$onCreated = function (
    $$itemstack,
    $$world,
    $$player
  ) {
  ...
  nmi_OvenItem.prototype.$onBlockDestroyed = function (
    $$itemstack,
    $$world,
    $$block,
    $$blockpos,
...
export function registerEntityServer(
  entityID: string,
  entityName: string,
  entityModel: string
) {
  ...
  var nme_OEntity = function nme_OEntity(this: any, $worldIn: any) {
    ...
    this.wrapped.tasks.addTask(
      3,
      AITask("EntityAITempt", 4)(this, 1.5, ModAPI.items.bread.getRef(), 0)
  ...
  nme_OEntity.prototype.$isBreedingItem = function (this: any, itemstack: any) {
    return (
      itemstack !== null && itemstack.$getItem() === ModAPI.items.bread.getRef()
    );
  };
  // END CUSTOM ENTITY
...
export function OvenMDK__defineExecCmdAsGlobal(): void {
  ...
  ).staticMethods.getServer?.method;

  // Define global function
  (globalThis as any).OvenMDK__executeCommandAs =
    function OvenMDK__executeCommandAs(
      $commandsender: any,
      command: string,
      feedback: boolean
    ): void {
...
export function registerOvenOreServer(
  block_ID: string,
  vienSize: number,
  vienCount: number,
