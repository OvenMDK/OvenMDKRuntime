...
export default class OEntity {
    ...
    private registerOEntity() {
        ...
        ModAPI.addEventListener("lib:asyncsink", async () => {
            ...
            AsyncSink.setFile(`resourcepacks/AsyncSinkLib/assets/minecraft/sounds/mob/${this.entityID}/quack.ogg`, await (await fetch(
            ...
            AsyncSink.Audio.register("mob." + this.entityID + ".quack", AsyncSink.Audio.Category.ANIMALS, [
                {
                    path: `sounds/mob/${this.entityID}/quack.ogg`,
                    pitch: 1,
                    volume: 1,
