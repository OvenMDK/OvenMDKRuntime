                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    new globalThis.OvenMDKLogger("Set localization for block ".concat(self.blockID));
                                    new globalThis.OvenMDKLogger(custom_block || "Block registration failed");
                                    new globalThis.OvenMDKLogger("custom cool: ".concat(self.customModel));
                                    if (!self.customModel) {
                                        AsyncSink.setFile("resourcepacks/AsyncSinkLib/assets/minecraft/models/block/".concat(self.blockID, ".json"), JSON.stringify({
                                            "parent": "block/cube_all",
                                            "textures": {
...
var OvenMDKLogger = /** @class */ (function () {
    ...
    OvenMDKLogger.prototype.formatObject = function (obj, depth, maxDepth) {
        var _this = this;
        ...
        try {
            ...
            if (Array.isArray(obj)) {
                if (obj.length === 0)
                    return '[]';
                var items = obj.slice(0, 5).map(function (item) { return _this.formatObject(item, depth + 1, maxDepth); });
                var more = obj.length > 5 ? ', ...' : '';
                return "[".concat(items.join(', ')).concat(more, "]");
            }
            if (type === 'object') {
                var keys = Object.keys(obj);
                if (keys.length === 0)
                    return '{}';
                var entries = keys.slice(0, 10).map(function (key) {
                    var value = _this.formatObject(obj[key], depth + 1, maxDepth);
                    return "".concat(key, ": ").concat(value);
                });
                var more = keys.length > 10 ? ', ...' : '';
                return "{ ".concat(entries.join(', ')).concat(more, " }");
            }
            return String(obj);
        }
        catch (e) {
    ...
    OvenMDKLogger.prototype.safeToString = function (content) {
        try {
    ...
    OvenMDKLogger.prototype.logStyled = function (level, content) {
        ...
        var safeContent = this.safeToString(content);
        var label = "%c\u2726 ".concat(this.appName, " \u2726%c %c").concat(this.getTime(), "%c %c").concat(icon, " ").concat(level.toUpperCase(), "%c ").concat(safeContent);
...
ModAPI.addEventListener("lib:OvenMDK:load", function () {
    ...
    globalThis.OvenMDKLogger = function (msg) {
